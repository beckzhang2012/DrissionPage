...
class ListenerMemoryStats(object):
    _total_packets: int = ...
    _degraded_count: int = ...
    _truncated_count: int = ...
    _skipped_count: int = ...
    _peak_queue_size: int = ...
    _peak_body_bytes: int = ...
    _total_body_bytes: int = ...
    _retained_count: int = ...
    ...
    def record_packet(self, body_size: int, is_degraded: bool = False,
                      is_truncated: bool = False, is_skipped: bool = False) -> None: ...
...
class Listener(object):
    ...
    _default_body_size_limit: int = ...
    _default_queue_size_limit: int = ...
    _degradation_mode_truncate: str = ...
    _degradation_mode_skip: str = ...
    _body_size_limit: int = ...
    _queue_size_limit: int = ...
    _degradation_mode: str = ...
    _memory_stats: ListenerMemoryStats = ...
    ...
    def set_memory_limits(self, body_size_limit: int = None, queue_size_limit: int = None,
        ...
        """设置内存保护限制
        :param body_size_limit: 单个body大小限制（字节），默认10MB，0表示不限制
        :param queue_size_limit: 队列大小限制，默认1000，0表示不限制
        :param degradation_mode: 降级模式，'truncate'截断或'skip'跳过
        :return: None
        """
        ...
...
class DataPacket(object):
    ...
    _body_degraded: bool = ...
    _body_truncated: bool = ...
    _body_skipped: bool = ...
    _original_body_size: int = ...
